...
function userCreation(socket, messageType, messageSubType){
	...
	this.createTestUser = function(){
		...
		var message1 = new Message(messageType.getUserCode(),messageSubType.getUserRegistration(),"null",user1.getJSON());	
		var user2 = new mdlUser();
		user2.createUser("PeterLustig","123123");
		var message2 = new Message(messageType.getUserCode(),messageSubType.getUserRegistration(),"null",user2.getJSON());
		var user3 = new mdlUser();
		user3.createUser("NicoLaus","123123");
		var message3 = new Message(messageType.getUserCode(),messageSubType.getUserRegistration(),"null",user3.getJSON());
